...
export const HOMEPAGE_URL = 'https://keystonelab.net';
export const DOCS_URL = 'https://keystonelab.net';
export const REPO_URL = 'https://github.com/KeystoneLabsLLC/keystone-umami';
